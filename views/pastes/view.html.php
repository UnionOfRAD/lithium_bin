<div class="view">
	<h2><?=$paste->preview;?></h2>
<?php
if ($paste->created == $paste->modified) {
	if (!$paste->author || $paste->author == '') { ?>
...
<?php }
	...
	if (!$paste->author || $paste->author == '') { ?>
	<h3>This <strong><?=$paste->language;?></strong> paste was last modified
		<strong>anonymously</strong>
		at <strong><?=$paste->modified;?></strong></h3>
<?php } else  { ?>
	<h3>This <strong><?=$paste->language;?></strong> paste was last modified by
		<strong><?=$paste->author;?></strong> at
		<strong><?=$paste->modified;?></strong></h3>
<?php
	}
}
?>
